...
/**
 * Cette fenêtre affiche une fenêtre où l'on choisit le bon enseignant parmi ceux qui ont le même nom.
 ...
 */
public class FenChoixEnsDonAux extends JFrame implements ActionListener{
	...
	/**
	 * Ce constructeur permet de sélectionner l'enseignant dont on veut modifier les informations si deux ont le même nom.
	 ...
	 */
	public FenChoixEnsDonAux(UserAdmin admin, String nom, String prenom) {
		this.admin = admin;
	 ...
	 *  On valide le choix de l'enseignant. 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == bValider) {
			dispose();
			ModifDonneesEns modifEtu = new ModifDonneesEns(admin,enseignant);
