...
public class ModifCollegeS extends JFrame implements ActionListener{
	...
	/**
	 * Ce constructeur permet de choisir le collège secondaire d'un enseignant
	...
	public ModifCollegeS(UserAdmin admin, Enseignant ens) {
		...
		this.setTitle("Modifier le collège secondaire"); // Modifier le titre de la fenetre
		...
		panModifCollS.setBackground(Color.LIGHT_GRAY); // on définit sa couleur de fond
		this.setContentPane(panModifCollS); // on prévient notre JFrame que pan sera son content pane
	 ...
	 * 	Le bouton valider confirme le choix du collège secondaire de l'enseignant. 
