...
/**
 * Cette fenêtre permet de choisir l'étudiant parmi un menu déroulant en vue d'imprimer leur fiche signalétique.
...
public class FenChoixEtuFicheAux extends JFrame implements ActionListener{
	...
	/**
	 * Ce constructeur permet de choisir l'étudiant dont on imprime la fiche signalétique. 
	 ...
	 *  On valide le choix de l'étudiant dont on imprime la fiche signalétique.
